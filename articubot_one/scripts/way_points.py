...
def draw_rect(h, w, navigator):
    ...
    goal_poses[1].pose.position.y = -15.0
    goal_poses[1] = set_angle(goal_poses[1], -1.57)

    goal_poses[2].pose.position.x = 2.0
    ...
    goal_poses[4].pose.position.y = -15.0
